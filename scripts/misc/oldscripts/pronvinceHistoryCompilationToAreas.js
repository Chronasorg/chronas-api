...
const folderDir = resolve("../../dataToMigrate/ExtendedTimeline/history/wars")
...
handleWarFile = (fileName) => new Promise((resolve, reject) => {
  // console.debug(fileName)
    ...
    lineReader.on('end', function () {
      // console.debug("name___" + entityName)
      // console.debug("start___" + start)
      // console.debug("end___" + end)
      // console.debug("attacker___" + attacker)
      // console.debug("defender___" + defender)
