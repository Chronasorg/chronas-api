                                          ...
                                          .then((ruler) => {
                                            ...
                                            if (ruler[1].length > 0 && (rulerImagesString.indexOf(".svg") > -1 || rulerImagesString.indexOf(".jpg") > -1 || rulerImagesString.indexOf(".jpeg") > -1 || rulerImagesString.indexOf(".png") > -1)) {
                                              ...
                                              fetch("https://commons.wikimedia.org/w/api.php?action=opensearch&search=" + firstWord + "&namespace=*&profile=fuzzy&limit=500")
                                                .then(response => response.json())
                                                .then((ruler) => {
                                                  while (ruler.length > 0) {
                                                    const potential = ruler.shift()
                                                    rulerImagesString = JSON.stringify(potential).toLowerCase()
                                                    if (potential.length > 0 && (rulerImagesString.indexOf(".svg") > -1 || rulerImagesString.indexOf(".jpg") > -1 || rulerImagesString.indexOf(".jpeg") > -1 || rulerImagesString.indexOf(".png") > -1)) {
                                                      // we found something valid, go on
                                                      return goOn(rulAcc, ruler[1], resolve, reject)
                                                    }
                                                  }
                                                    resolve()
                                                })
