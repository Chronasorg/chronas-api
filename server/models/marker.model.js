...
MarkerSchema.statics = {
   ...
   */
  list({ offset = 0, length = 2000, sort, order, filter, migrationDelta, delta, year = false, typeArray = false, wikiArray = false, format = false, search = false, includeMarkers = true, both = false } = {}) {
    if (+length === 0) {
